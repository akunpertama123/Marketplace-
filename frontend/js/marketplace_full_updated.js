// Versi marketplace_full.js dengan kelas CSS yang diperbarui untuk kartu produk agar sesuai dengan index.html
        ...
        col.innerHTML = `
            <div class="product-card">
                ...
                <div class="product-card-body">
                    ...
                    <button class="btn btn-outline-primary w-100 mt-3" onclick="showTemplateDetailsAsync('${template.id}')">View Details</button>
                </div>
            </div>
        `;
...
function searchTemplates() {
    ...
    templates
        ...
        .forEach(template => {
            ...
            col.className = 'col-md-4 mb-4';
            col.innerHTML = `
                <div class="product-card" onclick="showTemplateDetails('${template.id}')">
                    <div class="product-card-body">
                        <span class="template-type type-${template.type}">
                            ${template.type.charAt(0).toUpperCase() + template.type.slice(1)}
                        </span>
